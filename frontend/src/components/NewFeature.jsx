    ...
    <div class="container px-4 py-3" id="hanging-icons">
        ...
        <div class="row g-4 py-5 row-cols-1 row-cols-lg-3">
            ...
            <div class="col d-flex align-items-start py-3">
                <div class="icon-square text-body-emphasis text-bg-primary bg-gradient d-inline-flex align-items-center justify-content-center fs-4 flex-shrink-0 me-3">
            ...
            <div class="col d-flex align-items-start py-3">
                <div class="icon-square text-body-emphasis text-bg-primary bg-gradient d-inline-flex align-items-center justify-content-center fs-4 flex-shrink-0 me-3">
                    <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" class="bi bi-envelope-slash text-white" viewBox="0 0 16 16">
                ...
                <div>
                    <h3 class="fs-2 text-body-emphasis">Instant Unsubscribe</h3>
            ...
            <div class="col d-flex align-items-start py-3">
                <div class="icon-square text-body-emphasis text-bg-primary bg-gradient d-inline-flex align-items-center justify-content-center fs-4 flex-shrink-0 me-3">
                    <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" class="bi bi-trash3 text-white" viewBox="0 0 16 16">
